...
export default function Testimonios() {
  return (
    <div className="flex flex-col md:flex-row gap-4 md:gap-24 items-center justify-center px-12 md:px-4 pt-16 pb-48">
      <Image
        src={`/assets/home/testimonios/jerico.png`}
        width={280}
        height={320}
        alt="testimonios"
        className="rounded-full md:rounded-none w-56 h-56 md:w-auto"
      />
